...
#
# Source0 file verified with key 0xFFA7A68295C8BA96 (jimklimov@gmail.com)
#
Name     : nut
Version  : 2.8.3
Release  : 12
URL      : https://networkupstools.org/source/2.8/nut-2.8.3.tar.gz
Source0  : https://networkupstools.org/source/2.8/nut-2.8.3.tar.gz
Source1  : https://networkupstools.org/source/2.8/nut-2.8.3.tar.gz.sig
Source2  : FFA7A68295C8BA96.pkey
...
grep -E '^\[GNUPG:\] (GOODSIG|EXPKEYSIG) FFA7A68295C8BA96' gpg.status
%setup -q -n nut-2.8.3
cd %{_builddir}/nut-2.8.3
%patch -P 1 -p1
pushd ..
cp -a nut-2.8.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745447631
...
cp %{_builddir}/nut-%{version}/scripts/installer/common_EN/license.txt %{buildroot}/usr/share/package-licenses/nut/06877624ea5c77efe3b7e39b0f909eda6e25a4ec || :
export GOAMD64=v2
GOAMD64=v3
pushd ../buildavx2/
%make_install_v3
...
%files
%defattr(-,root,root,-)
/usr/lib/systemd/system-preset/nut-systemd.preset
...
/usr/include/nut/nutconf.hpp
/usr/include/nut/nutipc.hpp
...
/usr/lib64/pkgconfig/libnutconf.pc
...
/usr/share/man/man3/nutscan_add_ip_range.3
...
/usr/share/man/man3/nutscan_free_ip_ranges.3
/usr/share/man/man3/nutscan_get_serial_ports_list.3
/usr/share/man/man3/nutscan_init.3
/usr/share/man/man3/nutscan_init_ip_ranges.3
/usr/share/man/man3/nutscan_ip_ranges_iter_inc.3
/usr/share/man/man3/nutscan_ip_ranges_iter_init.3
...
/usr/share/man/man3/nutscan_stringify_ip_ranges.3
...
/usr/share/man/man3/upscli_get_default_connect_timeout.3
/usr/share/man/man3/upscli_init.3
/usr/share/man/man3/upscli_init_default_connect_timeout.3
...
/usr/share/man/man3/upscli_set_default_connect_timeout.3
/usr/share/man/man3/upscli_splitaddr.3
/usr/share/man/man3/upscli_splitname.3
/usr/share/man/man3/upscli_ssl.3
/usr/share/man/man3/upscli_str_add_unique_token.3
/usr/share/man/man3/upscli_str_contains_token.3
/usr/share/man/man3/upscli_strerror.3
/usr/share/man/man3/upscli_tryconnect.3
...
/V3/usr/lib64/libnutconf.so.0.0.1
/V3/usr/lib64/libnutscan.so.3.0.0
/V3/usr/lib64/libupsclient.so.7.0.0
...
/usr/lib64/libnutconf.so.0
/usr/lib64/libnutconf.so.0.0.1
/usr/lib64/libnutscan.so.3
/usr/lib64/libnutscan.so.3.0.0
/usr/lib64/libupsclient.so.7
/usr/lib64/libupsclient.so.7.0.0
...
/usr/share/man/man8/bicker_ser.8
/usr/share/man/man8/blazer_ser.8
/usr/share/man/man8/blazer_usb.8
/usr/share/man/man8/clone-outlet.8
...
/usr/lib/systemd/system/nut-logger.service
/usr/lib/systemd/system/nut-monitor.service
/usr/lib/systemd/system/nut-server.service
/usr/lib/systemd/system/nut-udev-settle.service
